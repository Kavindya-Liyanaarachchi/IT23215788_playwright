...
test('Pos_Fun_011 – Translate Singlish sentence to Sinhala', async ({ page }) => {
  // Step 1: Open application
  await page.goto('https://www.swifttranslator.com/');

  // Step 2: Enter Singlish text
  await page.locator('textarea').fill('Anee puluvan nam mata mee udhavva karalaa dhenavadha? loku dheyak');
