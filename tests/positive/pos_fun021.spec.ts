...
test('Pos_Fun_021 – Translate Singlish sentence to Sinhala', async ({ page }) => {
  // Step 1: Open application
  await page.goto('https://www.swifttranslator.com/');

  // Step 2: Enter Singlish text
  await page.locator('textarea').fill('api heta raeeta beach side ekee thiyena restaurant ekakata yamu');
