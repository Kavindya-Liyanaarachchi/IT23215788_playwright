...
test('Neg_Fun_010 – Mixed language and numeric values handling', async ({ page }) => {
  // Step 1: Open application
  await page.goto('https://www.swifttranslator.com/');

  // Step 2: Enter mixed Singlish + English + numbers
  await page.locator('textarea').fill(
    'Mee poddakata ape gewal paeththe enawadha? podi case ekak gaena kiyanna thiyenawaa'
  );
